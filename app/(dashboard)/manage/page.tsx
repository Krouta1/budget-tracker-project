...
import DeleteCategoryDialog from '../_components/DeleteCategorDialog';
...
function CategoryCard({ category }: { category: Category }) {
  return (
    <div className=' flex border border-separate flex-col justify-between rounded-md shadow-md shadow-black/[0.1] dark:shadow-white/[0.1]'>
